...
3. *Analyzing Categorical Variables* ([LMR_1.18](../IDS_Curriculum_v_5.0/2_IDS_LMRs_v_5.0/IDS_LMR_Unit 1_v_5.0/LMR_1.18_Analyzing Categorical Variables.pdf))

    **Advanced preparation required** (see step 19 below)

4. *Interpreting Categorical Variables* ([LMR_1.19](../IDS_Curriculum_v_5.0/2_IDS_LMRs_v_5.0/IDS_LMR_Unit 1_v_5.0/LMR_1.19_Interpreting Categorical Variables.pdf))
...
19. Distribute one full set of cards from the *Analyzing Categorical Variables* file ([LMR_1.18](../IDS_Curriculum_v_5.0/2_IDS_LMRs_v_5.0/IDS_LMR_Unit 1_v_5.0/LMR_1.18_Analyzing Categorical Variables.pdf)) to each
student team.

    **<u>Advanced preparation required:</u>**

    Print the *Analyzing Categorical Variables* file ([LMR_1.18](../IDS_Curriculum_v_5.0/2_IDS_LMRs_v_5.0/IDS_LMR_Unit 1_v_5.0/LMR_1.18_Analyzing Categorical Variables.pdf)). The handouts can then be cut into a
    ...
    <div align="right"><iframe src="https://docs.google.com/viewerng/viewer?url=https://stemc.idsucla.org/IDS_Curriculum_v_5.0_preview/2_IDS_LMRs_v_5.0/IDS_LMR_Unit 1_v_5.0/LMR_1.18_Analyzing Categorical Variables.pdf&embedded=true" style=" width:420px;height:400px;" frameborder="0"></iframe><br>[LMR_1.18](../IDS_Curriculum_v_5.0/2_IDS_LMRs_v_5.0/IDS_LMR_Unit 1_v_5.0/LMR_1.18_Analyzing Categorical Variables.pdf)</div>

20. Distribute [LMR_1.19_*Interpreting Categorical Variables*](../IDS_Curriculum_v_5.0/2_IDS_LMRs_v_5.0/IDS_LMR_Unit 1_v_5.0/LMR_1.19_Interpreting Categorical Variables.pdf) to each student team.

    <div align="right"><iframe src="https://docs.google.com/viewerng/viewer?url=https://stemc.idsucla.org/IDS_Curriculum_v_5.0_preview/2_IDS_LMRs_v_5.0/IDS_LMR_Unit 1_v_5.0/LMR_1.19_Interpreting Categorical Variables.pdf&embedded=true" style=" width:420px;height:400px;" frameborder="0"></iframe><br>[LMR_1.19](../IDS_Curriculum_v_5.0/2_IDS_LMRs_v_5.0/IDS_LMR_Unit 1_v_5.0/LMR_1.19_Interpreting Categorical Variables.pdf)</div>
...
citing a numerical summary as evidence.
    ...
    **<u>Note:</u>** Student teams may tapeu or glue visuals and numerical summaries onto [LMR_1.19](../IDS_Curriculum_v_5.0/2_IDS_LMRs_v_5.0/IDS_LMR_Unit 1_v_5.0/LMR_1.19_Interpreting Categorical Variables.pdf), or they
...
22. After student teams have been allotted ample time to complete [LMR_1.19](../IDS_Curriculum_v_5.0/2_IDS_LMRs_v_5.0/IDS_LMR_Unit 1_v_5.0/LMR_1.19_Interpreting Categorical Variables.pdf), lead a class
